...
Make sure you can both send and recieve comfortably.
```
...
So you have your `BIP39` phrase secured.  You are now ready to recieve some cryptocurrency.  Let us run through the steps to get one.
...
1. That is it!  You are now ready to recieve payment to that address.
